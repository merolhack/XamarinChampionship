...
namespace Reto6
{
    ...
    public class CognitiveActivity : Activity
	{
		...
		string ResultadoEmociones = "Reto6 + mx + Lenin: ";
		...
		private async void BtnRegistraResultados_Click(object sender, EventArgs e)
		{
			...
			registro.DeviceId = Android.Provider.Settings.Secure.GetString(
				ContentResolver,
				Android.Provider.Settings.Secure.AndroidId
			);
			registro.Email = "merolhack@gmail.com";
		...
		private async void BtnAnalizaFoto_Click(object sender, EventArgs e)
		{
			if (streamCopy != null)
			{
				...
				Log.Info("CognitiveActivity", "Analizar...");
				try
				{
				...
				if (emotions != null)
				{
					...
					foreach (var item in emotions)
					{
						...
						Log.Info("CognitiveActivity", toAdd);
						sb.Append(toAdd);
					}
